...
namespace Ftp_File_Share
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        //public static string connectionString = ConfigurationManager.ConnectionStrings["fallstarConnection"].ConnectionString;
        //
        //Data Source=10.3.12.130;Initial Catalog=CoilDB_SIS01;Persist Security Info=True;User ID=steinb;Password=12345

        //public static string g_Sqlstring = "Data Source=10.3.86.126;Initial Catalog=level2_data;Persist Security Info=True;User ID=sa;Password=sa123456";




        //127.0.0.1,49685\sqlexpress 非默认实例名及端口号
        ...
        public static DataTable RunProcedureGetDataTable(string storedProcName, SqlParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
